...
fun Any.v(tag: String, message: String, exception: Exception?) {
    Log.v(tag, message, exception)
}

fun Any.d(tag: String, message: String, exception: Exception?) {
    Log.d(tag, message, exception)
}

fun Any.i(tag: String, message: String, exception: Exception?) {
    Log.i(tag, message, exception)
}

fun Any.w(tag: String, message: String, exception: Exception?) {
    Log.w(tag, message, exception)
}

fun Any.e(tag: String, message: String, exception: Exception?) {
